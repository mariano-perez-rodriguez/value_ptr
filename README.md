...
- [The Code](#the-code)
  ...
  - [The `value_ptr` Class](#the-value_ptr-class)
    ...
    - [Constructors and Destructor](#constructors-and-destructor)
      ...
      - [`auto_ptr` Constructors](#auto_ptr-constructors)
      - [`unique_ptr` Constructors](#unique_ptr-constructors)
      - [`shared_ptr` Constructors](#shared_ptr-constructors)
      - [`weak_ptr` Constructors](#weak_ptr-constructors)
